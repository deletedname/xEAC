        ...
        <dd>
            <xsl:choose>
                <xsl:when test="eac:term">
                    ...
                    <!-- adding dates and descriptive notes to terms IL 20160910
                     NOTE: this could probably be written more elagantly using a defined template
                     &#xa; displaying a space instead of a carriage return -->
                    <xsl:if test="ancestor-or-self::node()/eac:date|eac:dateRange|eac:dateSet">
                        <span class="subtle">
                        <br>
                    ...
                    <xsl:if test="string(eac:descriptiveNote)">
                        <br>
                            <xsl:text>note: </xsl:text><xsl:value-of select="string-join(eac:descriptiveNote/eac:p, ' &#xa;')"/>
                        </br>
                    </xsl:if>
                ...
                <xsl:when test="eac:placeEntry">
                    ...
                    <!-- adding placeRole in parentheses IL 20160822 -->
                    <xsl:if test="string(eac:placeRole)">
                        <span class="subtle">
                        <br>
                            <xsl:text>(</xsl:text>
                    ...
                    <!--
                     descriptiveNote added IL 20160901
                     dates added to places IL 20160906
                     &#xa; displaying a space instead of a carriage return -->
                        ...
                        <xsl:if test="string(eac:descriptiveNote)">
                            <br>
                                <xsl:value-of select="string-join(eac:descriptiveNote/eac:p, ' &#xa;')"/>
                            </br>
                        </xsl:if>
